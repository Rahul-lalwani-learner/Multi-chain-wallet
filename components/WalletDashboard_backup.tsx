  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 flex flex-col md:flex-row">
      ...
      <div className={clsx(
        ...
        // Mobile behavior - overlay when expanded
        !sidebarCollapsed && 'md:hidden fixed inset-y-0 left-0 z-40 w-80'
      )}>
        {/* Sidebar Header */}
      ...
      {showNetworkDropdown && (
        <>
          ...
          />
          {/* Dropdown */}
          <div className="fixed top-20 right-6 bg-white/15 backdrop-blur-lg border border-white/30 rounded-lg overflow-hidden z-[9999] min-w-[160px] shadow-xl">
