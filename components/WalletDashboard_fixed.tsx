              ...
              <div className="flex items-center gap-3">
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 bg-white/10 border border-white/20 rounded-lg px-4 py-2 text-white hover:bg-white/20 transition-all duration-200"
                  >
                  ...
                  {showNetworkDropdown && (
                    <>
                      ...
                      />
                      {/* Dropdown */}
                      <div className="absolute right-0 top-full mt-2 bg-white/15 backdrop-blur-lg border border-white/30 rounded-lg overflow-hidden z-[9999] min-w-[160px] shadow-xl">
        ...
        <div className="flex-1 p-6 overflow-y-auto">
          {currentWallet ? (
            <div className="max-w-4xl mx-auto space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    >
                      <RefreshCw className={clsx('w-5 h-5', currentWallet && loadingBalances[currentWallet.id] && 'animate-spin')} />
                    </button>
                  </div>
                  <div className="text-3xl font-bold text-white mb-2">
                    {currentWallet && balances[currentWallet.id]?.solana 
                      ? parseFloat(balances[currentWallet.id].solana).toFixed(6)
                      : '0.000000'
                    }
                  </div>
                ...
                <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                  ...
                  <div className="text-3xl font-bold text-white mb-2">
                    {currentWallet && balances[currentWallet.id]?.ethereum 
                      ? parseFloat(balances[currentWallet.id].ethereum).toFixed(6)
                      : '0.000000'
                    }
                  </div>
              ...
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 bg-black/20 border border-white/20 rounded-lg px-4 py-3">
                      ...
                      <button
                        ...
                        className="p-3 bg-purple-600 rounded-lg text-white hover:bg-purple-700 transition-all duration-200"
                        title="Copy Address"
                      >
                      ...
                      <button
                        ...
                        className="p-3 bg-blue-600 rounded-lg text-white hover:bg-blue-700 transition-all duration-200"
              ...
              {/* Private Keys */}
              <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
                <h3 className="text-xl font-semibold text-white mb-4">Private Keys</h3>
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <button
                        ...
                        className="p-3 bg-gray-600 rounded-lg text-white hover:bg-gray-700 transition-all duration-200"
                        title="Toggle Visibility"
                      >
                        {currentWallet && showPrivateKey[currentWallet.id] ? <EyeOff className="w-4 h-4" /> : <Eye className="w-4 h-4" />}
                      </button>
                      <button
